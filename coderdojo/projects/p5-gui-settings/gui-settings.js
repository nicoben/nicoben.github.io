...
function setup() {
    ...
    // Create Layout GUI
    gui1 = createGui('Layout');
    sliderRange(0, 100, 1);
    gui1.addGlobals('numShapes', 'bigRadius');
...
class Params {
    ...
    toString() {
        return "Params(" + this.foo.toString() + ", " + this.bar +  ")";
    }
}
...
function keyPressed() {
    switch (key) {
        ...
        case 'p':
            visible = !visible;
            if (visible) gui1.show(); else gui1.hide();
